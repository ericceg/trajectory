...
- Advanced Analytics supports JSON export/import of custom definitions (metrics/streaks/charts + auto-run) for sharing setups across devices/friends
...
5. Explore:
   ...
   - In **Advanced Analytics**, use **Export JSON** / **Import JSON** to share your metrics, streaks, and chart definitions
