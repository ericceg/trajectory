...
- Advanced Analytics metric/chart time ranges are configured in **Configure**; the **View** tab is read-only and shows the active range per card as an indicator
