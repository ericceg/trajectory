...
5. Explore:
   ...
   - In **Advanced Analytics**, **Export JSON** / **Import JSON** opens a selection panel where you can pick exact metrics/streaks/charts; required metric dependencies are auto-selected, and import merges selected definitions into your existing library by ID instead of replacing the full library
